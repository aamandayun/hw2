...
{
  return new Book(isbn_, author_, categoryID(), prodName_, price_, qty_);
...
return new Clothing(size_, brand_, categoryID(), prodName_, price_, qty_);
...
{
  return new Movie(genre_, rating_, categoryID(), prodName_, price_, qty_);
}
